 ...
 */
let argsTransform: ArgsTransform | undefined;

/**
 * Sets a function that will be used to transform the arguments before sending them to the main process.
 */
export const setArgsTransform = (transform: ArgsTransform) => {
